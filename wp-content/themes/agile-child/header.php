...
<head>
    ...
    $(document).ready(function(){
        $(".lsow-panel-title1").click(function(){
            document.getElementById('myImage').src='http://fickhoinghiep.com/wp-content/uploads/2016/12/THÀNH-LẬP.jpg';
        });
        $(".lsow-panel-title2").click(function(){
            document.getElementById('myImage').src='http://fickhoinghiep.com/wp-content/uploads/2016/12/SỨ-MỆNH.jpg';
        });
        $(".lsow-panel-title3").click(function(){
            document.getElementById('myImage').src='http://fickhoinghiep.com/wp-content/uploads/2016/12/MỤC-TIÊU-1.jpg';
        });
    });
    </script>
